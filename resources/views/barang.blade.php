                                                ...
                                                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>{{$no++}}</td>
                                                            <td>{{$f->nama}}</td>
                                                            <td><img src="{{ url('/img/'.$f->image) }}" style="width:100x; height: 100px;"></td>                                                            <td>{{$f->qty}}</td>
            ...
            <div class="modal-body">
                <form name="frm_add" id="frm_add" action="simpan{{$fileName}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group"><label class="control-label">Barang</label>
                        <div><input type="text" name="nama" id="" placeholder="Nama barang" class="form-control" required></div>
                    </div>
                    <div class="form-group"><label class="control-label">Image</label>
                    <input type="file" class="form-control" name="file">
                    </div>
                    <div class="form-group"><label class="control-label">Banyak barang</label>
                        <div><input type="text" name="qty" id="" placeholder="jumlah" class="form-control" required></div>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="frm_add" id="frm_add" action="update{{$fileName}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group"><label class="control-label">Barang</label>
                        <div><input type="text" name="nama" id="nama" placeholder="Nama barang" class="form-control" required></div>
                    </div>
                    <div class="form-group"><label class="control-label">Image</label>
                    <input type="file" class="form-control" name="file" id="file">
                    </div>
                    <div class="form-group"><label class="control-label">Banyak barang</label>
                        <div><input type="text" name="qty" id="qty" placeholder="jumlah" class="form-control" required></div>
                    </div>
