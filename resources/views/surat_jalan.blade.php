...
// QRcode::png("/kendaraanSatpamdetail" . $codeContents . "SekperTITirtaasasta", $tujuan_upload . "001.png");
QRcode::png("/kendaraanSatpamdetail" . $codeContents . "SekperTITirtaasasta", $tujuan_upload . "001.png");
?>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="invoice-title">
                                ...
                                <h4 class="pull-right">Surat Jalan</h4>
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    <address>
                                        ...
                                        Nama : {{$peminjaman->pegawai->nama}}<br>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="hidden-print">
                                        <div class="pull-right">
                                            <input class="btn btn-sm btn-success" type="button" onclick="printDiv('printableArea')" value="PRINT">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="row">
                                            <div class="col-xs-12">
                                                ...
                                                <h6>1. Setiap mengembalikan kendaraan dinas harus dalam keadaan bersih dan kondisi BBM seperti semula</h6>
                                                <h6>2. Kerusakan atau kehilangan kendaraan dinas menjadi tanggung jawab pengguna</h6>
                                                <h6>3. Apabila terjadi sesuatu terhadap kendaraan dinas agar segera melapor ke Rumah Tangga dan Umum</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
