        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="frm_add" id="frm_add" action="simpan{{$fileName}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group"><label class="control-label">Nama Divisi</label>
                        <div><input type="text" name="nama" id="" placeholder="Nama Divisi" class="form-control" required></div>
                    </div>
